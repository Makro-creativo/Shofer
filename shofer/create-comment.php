<?php 
    ...
    if(isset($_POST['saveComment'])) {
        ...
        $query_save_comment = "INSERT INTO comments(id_order, image, description, from_id, to_id, status, created_at, id_user) VALUES('$idOrder', '$ruta', '$description', '$uid', '1', '0', NOW(), '$uid')";

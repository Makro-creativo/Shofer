<?php 
    ...
    if(isset($_POST['save'])) {
        ...
        $query_drivers = "INSERT INTO drivers(id_user, name_driver, vehicle, plates, adress, account_number, price_for_kilometer, image_ine, image_circulacion, image_personal, card_number, bank, created_at) VALUES('$uid', '$nameChofer', '$vehicle', '$plates', '$adress', '$accountNumber', '$price', '$ruta', '$ruta2', '$ruta3', '$cardNumber', '$bank', NOW())";
